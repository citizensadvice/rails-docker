...
RUN wget -O - https://www.postgresql.org/media/keys/ACCC4CF8.asc | apt-key add - && \
    ...
    apt-get install -y build-essential imagemagick libmagic-dev nodejs-legacy xvfb fontconfig libxfont1 xfonts-base xfonts-encodings xfonts-utils x11-common p7zip-full && \
